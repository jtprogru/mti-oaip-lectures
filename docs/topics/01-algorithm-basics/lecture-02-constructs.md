...
![Деление дробей — формула](../../assets/img/topic-01/lecture-02-p01.png)
...
Составим алгоритм решения квадратного уравнения `a·x² + b·x + c = 0`. Исходные данные — коэффициенты `a`, `b`, `c`. Решением в общем случае будут два корня x₁ и x₂, которые вычисляются по формуле:

![Формула корней квадратного уравнения](../../assets/img/topic-01/lecture-02-p03.png)
